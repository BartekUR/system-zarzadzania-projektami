...
CREATE TABLE IF NOT EXISTS `projekty` ( `ID_Projekt` int(11) NOT NULL, `Nazwa_projektu` varchar(50) NOT NULL, `Head` text NOT NULL, `Status` varchar(50) NOT NULL, `Termin` date NOT NULL, PRIMARY KEY (`ID_Projekt`)) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS `taski` ( `ID_Task` int(11) NOT NULL, `ID_Projekt_FK` int(11) NOT NULL, `Nazwa_tasku` varchar(50) NOT NULL, `Status` varchar(50) NOT NULL, `Termin` date NOT NULL, PRIMARY KEY (`ID_Task`), KEY `ID_Projekt_FK` (`ID_Projekt_FK`), CONSTRAINT `ID_Projekt_FK` FOREIGN KEY (`ID_Projekt_FK`) REFERENCES `projekty` (`ID_Projekt`) ON DELETE CASCADE ON UPDATE CASCADE) ENGINE=InnoDB;
