...
CREATE TABLE IF NOT EXISTS `projekty` ( `ID_Projekt` int(11) NOT NULL, `Nazwa_projektu` varchar(50) NOT NULL, `Head` text NOT NULL, `Status` varchar(50) NOT NULL, `Progress` varchar(50) NOT NULL, `Termin` date NOT NULL, PRIMARY KEY (`ID_Projekt`)) ENGINE=InnoDB;
